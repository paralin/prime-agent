...
export function buildRlmPrompt(options: RlmPromptOptions): string {
	...
	const parts = [
		...
		"Improve the component that implements the behavior. Use its existing interface, simplify confusing structure, and remove code the change makes obsolete. Favor useful implementation and coherent design over speculative generality or procedural overhead.",
