...
export const MODELS = {
	...
	"merge-gateway": {
		"anthropic/claude-opus-4-6": {
			...
			compat: {"reasoningField":"thinking","requireFinishReason":true,"supportsStore":true,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","thinkingFormat":"merge","sendSessionAffinityHeaders":["x-session-affinity","X-Session-Id"]},
			reasoning: true,
			thinkingLevelMap: {"max":"max"},
			input: ["text", "image"],
			cost: {
