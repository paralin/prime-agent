...
export function formatHarnessStateForPrompt(
	...
	const lines = [
		...
		"The entries below are compact routing and context hints. They may omit qualifications, so check one against current source or behavior when it drives a consequential or hard-to-reverse action.",
