...
export const MODELS = {
	...
	"merge-gateway": {
		...
		"zai/glm-5.3-flash": {
			...
			provider: "merge-gateway",
			baseUrl: "https://api-gateway.merge.dev/v1",
			compat: {"sendSessionIdHeader":false,"supportsStore":false,"supportsPromptCache":false,"supportsReasoning":false,"supportsDeveloperRole":false,"requiresStringMessageContent":true,"includeRoutingMetadata":true,"supportsLongCacheRetention":false},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.015,
