...
export const MODELS = {
	...
	"merge-gateway": {
		...
		"zai/glm-5.3-flash": {
			...
			provider: "merge-gateway",
			baseUrl: "https://api-gateway.merge.dev/v1",
			compat: {"sendSessionIdHeader":false,"supportsStore":false,"supportsPromptCache":false,"supportsReasoning":false,"supportsDeveloperRole":false,"supportsTools":false,"supportsLongCacheRetention":false},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0.015,
	...
	"openrouter": {
		...
		"deepseek/deepseek-v4-pro": {
			...
			input: ["text"],
			cost: {
				input: 0.7113119999999999,
				output: 1.4226239999999999,
				cacheRead: 0.059276,
				cacheWrite: 0,
			},
			contextWindow: 1048576,
